USE DataWarehouse;
/*
	This Script is used to create the Table structure of the data 
	stored in the bronze layer (The table structure stays the same).
	Here we also add an extra column to each table which tells the 
	date of last update.
	If table already exists then running this script will delete 
	the table.
*/
